            ...
            <div className='flex flex-col gap-16'>
                ...
                <div className='space-y-5'>
                    ...
                    <div className='space-y-4'>
                        <p className='uppercase hover:text-[#f8a065] cursor-pointer text-sm'>(commercial)</p>
                        <p className='uppercase hover:text-[#f8a065] cursor-pointer text-sm'>(creative)</p>
                        <p className='uppercase hover:text-[#f8a065] cursor-pointer text-sm'>(graphic design)</p>
                        <p className='uppercase hover:text-[#f8a065] cursor-pointer text-sm'>(marketing)</p>
                        <p className='uppercase hover:text-[#f8a065] cursor-pointer text-sm'>(photography)</p>
                        <p className='uppercase hover:text-[#f8a065] cursor-pointer text-sm'>(urban)</p>
                    </div>
                </div>
                <div className='space-y-5'>
                ...
                <div className='space-y-5'>
                    ...
                    <div className='flex gap-4 flex-wrap'>
                        <p className='uppercase border border-black w-fit rounded-full py-1 px-4 hover:bg-[#f8a065] hover:text-white cursor-pointer text-sm'>commercial</p>
                        <p className='uppercase border border-black w-fit rounded-full py-1 px-4 hover:bg-[#f8a065] hover:text-white cursor-pointer text-sm'>cool</p>
                        <p className='uppercase border border-black w-fit rounded-full py-1 px-4 hover:bg-[#f8a065]  hover:text-white cursor-pointer text-sm'>design</p>
                        <p className='uppercase border border-black w-fit rounded-full py-1 px-4 hover:bg-[#f8a065] hover:text-white cursor-pointer text-sm'>development</p>
                        <p className='uppercase border border-black w-fit rounded-full py-1 px-4 hover:bg-[#f8a065] hover:text-white cursor-pointer text-sm'>marketing</p>
                    </div>
                </div>
